...
export default function Chat() {
  ...
  return (
    <DashboardLayout>
      <div className="h-full flex flex-col justify-between p-3 container">
        <div
              ...
              >
                <div>
                  <div className="bg-white max-w-[600px] px-4 text-brand__font__size__sm border rounded-xl shadow flex justify-start text-primary">
                    {isUser ? (
                      <span className="py-3 inline-block">{item?.content}</span>
                    ) : isNew ? (
                      <Typewriter
                        text={item?.content}
                        speed={50}
                      ...
                      <ul className="flex flex-col">
                        {nodes.map((nodeItem) => {
                          ...
                          return (
                            <li
                              key={nodeItem?.id}
                              className="inline-block bg-white px-2 py-1.5 mb-1 text-brand__font__size__xs w-fit shadow"
                            >
                              <a
                  ...
                  {!isUser ? (
                    <div className="px-2 flex items-center gap-x-4 text-brand__font__size__xs mt-1 font-brand__font__600 text-primary">
                      ...
                      <button className="flex items-center justify-between gap-x-1 hover:text-text__link duration-200">
                        <FaFileAlt size={10} />
                        <small>Note</small>
                      </button>
                    </div>
